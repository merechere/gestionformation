...
<head>
    ...
    <style>
        #liste-medecin .btn-outline-primary,
        #liste-medecin .btn-outline-warning,
        #liste-medecin .btn-outline-danger {
            transition: 0.1s;
        }

        #liste-medecin .btn-outline-primary:hover,
        #liste-medecin .btn-outline-warning:hover,
        #liste-medecin .btn-outline-danger:hover {
            color: #fff;
